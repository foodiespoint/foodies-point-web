// ==========================================================================
// 1. PWA REGISTRATION & AGGRESSIVE INSTALL (WITH CACHE-BUSTING V7)
// ==========================================================================
...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        // Appending ?v=7 forces the phone's browser network layer to skip the static HTTP file cache
        navigator.serviceWorker.register('sw.js?v=7')
            .then(reg => {
                console.log('PWA Service Worker engine running cleanly.');
                // Forces the service worker to fetch updates immediately on application boot
                reg.update(); 
            })
...
window.addEventListener('beforeinstallprompt', (e) => {
    ...
    // 24-hour cycle bypassed. App blocks screen on every launch until installed!
