// ==========================================================================
// 1. PWA LIFECYCLE HANDSHAKE & SPLASH SCREEN SYSTEM (VERSION 25)
// ==========================================================================
...
// ==========================================================================
// 🚀 9. ADMINISTRATIVE MASTER MENU CONTROL ENGINE (ALL 102 ITEMS DEPLOYED) 
// ==========================================================================
let isConsoleViewActive = false;
const ROUTING_SECRET_PIN = "validatefoodies2026"; 

const MASTER_MENU = [
    // ROLLS [cite: 1, 2, 3, 4, 5]
    { id: "roll_1", title: "Dahi Bread Roll", details: "15/- per pc.", category: "ROLLS" }, [cite: 1]
    { id: "roll_2", title: "Bread Roll", details: "80/- per plate (8 pc.)", category: "ROLLS" }, [cite: 1]
    { id: "roll_3", title: "Spring Roll", details: "25/- per pc.", category: "ROLLS" }, [cite: 1]
    { id: "roll_4", title: "Veg Kebab Roll", details: "20/- per pc.", category: "ROLLS" }, [cite: 2]
    { id: "roll_5", title: "Paneer Roll", details: "45/- per pc.", category: "ROLLS" }, [cite: 2]
    { id: "roll_6", title: "Egg Mayonaise & Cheese Mix Roll", details: "50/- per pc.", category: "ROLLS" }, [cite: 3]
    { id: "roll_7", title: "Egg Mayonaise Roll", details: "40/- per pc.", category: "ROLLS" }, [cite: 3]
    { id: "roll_8", title: "Egg Roll", details: "35/- per pc.", category: "ROLLS" }, [cite: 4]
    { id: "roll_9", title: "Chicken Roll", details: "55/- pr pc.", category: "ROLLS" }, [cite: 4]
    { id: "roll_10", title: "Chicken Mayonaise Roll", details: "60/- per pc.", category: "ROLLS" }, [cite: 4]
    { id: "roll_11", title: "Chicken Egg Roll", details: "70/- per pc.", category: "ROLLS" }, [cite: 5]
    { id: "roll_12", title: "Chicken Egg Mayonaise Roll", details: "75/-", category: "ROLLS" }, [cite: 5]

    // PAKODI [cite: 5, 6]
    { id: "pak_1", title: "Pyaaz ki Pakodi", details: "60 (250gm)", category: "PAKODI" }, [cite: 5]
    { id: "pak_2", title: "Paalak ki pakodi", details: "60 (250gm)", category: "PAKODI" }, [cite: 5]
    { id: "pak_3", title: "Gobhi ki pajkodi", details: "60 (250gm)", category: "PAKODI" }, [cite: 5]
    { id: "pak_4", title: "Mirch ki pakodi", details: "15 per pc.", category: "PAKODI" }, [cite: 5]
    { id: "pak_5", title: "Bread Pakoda", details: "20/- per pc.", category: "PAKODI" }, [cite: 6]
    { id: "pak_6", title: "Egg pakodi", details: "10/- per pc", category: "PAKODI" }, [cite: 6]
    { id: "pak_7", title: "Moong daal ke mongode (pakodi)", details: "75 (250gm)", category: "PAKODI" }, [cite: 6]

    // SANDWICH [cite: 6]
    { id: "sand_1", title: "Veg Grilled Mayonaise Sandwich", details: "55/- (2 pc)", category: "SANDWICH" }, [cite: 6]
    { id: "sand_2", title: "Veg Cheese Sandwich", details: "60/- (2 pc)", category: "SANDWICH" }, [cite: 6]
    { id: "sand_3", title: "Veg Sandwich", details: "18/- per pc", category: "SANDWICH" }, [cite: 6]

    // SNACKS [cite: 6, 7, 8]
    { id: "snack_1", title: "Chocolate Croissant", details: "48 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_2", title: "Zingy Parcel (Paneer)", details: "60 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_3", title: "Pizza Puff", details: "18 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_4", title: "Mini Pizza", details: "45 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_5", title: "Veg Burger", details: "50 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_6", title: "Aloo Patty", details: "17 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_7", title: "Paneer Patty", details: "25 per pc", category: "SNACKS" }, [cite: 6]
    { id: "snack_8", title: "Veg Appe", details: "65 per plate", category: "SNACKS" }, [cite: 6]
    { id: "snack_9", title: "Phare", details: "70 250gm", category: "SNACKS" }, [cite: 6]
    { id: "snack_10", title: "Veg Masala Idli", details: "45 per plate", category: "SNACKS" }, [cite: 6]
    { id: "snack_11", title: "Fried Idli", details: "50 per plate", category: "SNACKS" }, [cite: 6]
    { id: "snack_12", title: "Poha", details: "80 per plate", category: "SNACKS" }, [cite: 6]
    { id: "snack_13", title: "Stuffed Mushroom", details: "65 per plate (4 pc)", category: "SNACKS" }, [cite: 7]
    { id: "snack_14", title: "Aloo Bonda", details: "12 per pc", category: "SNACKS" }, [cite: 7]
    { id: "snack_15", title: "Vada Pav", details: "25 per pc", category: "SNACKS" }, [cite: 7]
    { id: "snack_16", title: "Cheese Balls", details: "80 per plate (8 pc)", category: "SNACKS" }, [cite: 7]
    { id: "snack_17", title: "Masala Vada", details: "80 per plate (8 pc)", category: "SNACKS" }, [cite: 7]
    { id: "snack_18", title: "Falafel Mushakkal Veg. Roll", details: "40", category: "SNACKS" }, [cite: 7, 8]
    { id: "snack_19", title: "Pani Poori", details: "15 (5 pc)", category: "SNACKS" }, [cite: 8]
    { id: "snack_20", title: "Tikki Chaat", details: "55 per plate", category: "SNACKS" }, [cite: 8]
    { id: "snack_21", title: "Dahi vada", details: "60 per plate (4pc)", category: "SNACKS" }, [cite: 8]
    { id: "snack_22", title: "Raj Kachori", details: "85 per plate", category: "SNACKS" }, [cite: 8]
    { id: "snack_23", title: "Samosa", details: "12 per pc", category: "SNACKS" }, [cite: 8]
    { id: "snack_24", title: "Paneer Tikka", details: "240 per plate", category: "SNACKS" }, [cite: 8]
    { id: "snack_25", title: "Paneer Malai Tikka", details: "260 per plate", category: "SNACKS" }, [cite: 8]

    // CHINESE [cite: 8]
    { id: "chin_1", title: "Honey Chilli Potato", details: "90 per plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_2", title: "Chowmein", details: "80 per plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_3", title: "Macaroni", details: "80 per plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_4", title: "Fried Rice", details: "80 per plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_5", title: "Veg Manchurian", details: "80 pr plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_6", title: "Paneer Manchurian", details: "160 per plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_7", title: "Chilli Paneer", details: "140 per plate", category: "CHINESE" }, [cite: 8]
    { id: "chin_8", title: "Veg momos", details: "55 per plate (10 pc)", category: "CHINESE" }, [cite: 8]
    { id: "chin_9", title: "Paneer momos", details: "75 per plate (10 pc)", category: "CHINESE" }, [cite: 8]
    { id: "chin_10", title: "Chicken momos", details: "100 per plate (10 pc)", category: "CHINESE" }, [cite: 8]
    { id: "chin_11", title: "White Pasta", details: "100 per plate", category: "CHINESE" }, [cite: 8]

    // KEBEBS [cite: 9]
    { id: "keb_1", title: "Veg. Seekh Kebab", details: "15 per pc", category: "KEBEBS" }, [cite: 9]
    { id: "keb_2", title: "Veg Kebab", details: "17 per pc", category: "KEBEBS" }, [cite: 9]
    { id: "keb_3", title: "Dahi ke kebab", details: "25 per pc", category: "KEBEBS" }, [cite: 9]
    { id: "keb_4", title: "Hariyali kebab", details: "25 per pc", category: "KEBEBS" }, [cite: 9]

    // CAKE (Egg-Less) [cite: 9]
    { id: "cake_1", title: "Tutti Frutti Cup Cake", details: "18 per pc", category: "CAKE (Egg-Less)" }, [cite: 9]
    { id: "cake_2", title: "Chocolate Cup Cake", details: "20 per pc", category: "CAKE (Egg-Less)" }, [cite: 9]
    { id: "cake_3", title: "Chocolava Cup Cake", details: "38 per pc", category: "CAKE (Egg-Less)" }, [cite: 9]

    // SHAKES [cite: 9]
    { id: "shake_1", title: "Mango Shake", details: "30", category: "SHAKES" }, [cite: 9]
    { id: "shake_2", title: "Lassi", details: "45", category: "SHAKES" }, [cite: 9]
    { id: "shake_3", title: "Panna", details: "12", category: "SHAKES" }, [cite: 9]

    // TRADITIONAL / COMBO PLATES [cite: 9]
    { id: "trad_1", title: "Chokha Baati", details: "50 per plate (2 pc)", category: "COMBOS" }, [cite: 9]
    { id: "trad_2", title: "Chole Aloo Kulche", details: "70 per plate", category: "COMBOS" }, [cite: 9]
    { id: "trad_3", title: "Chole Bhature", details: "60 per plate", category: "COMBOS" }, [cite: 9]
    { id: "trad_4", title: "Khasta Aloo Matar", details: "55 per plate (2 pc)", category: "COMBOS" }, [cite: 9]
    { id: "trad_5", title: "Sambhar Vada", details: "55 per plate (4 pc)", category: "COMBOS" }, [cite: 9]
    { id: "trad_6", title: "Idli Sambhar", details: "55 per plate (4 pc)", category: "COMBOS" }, [cite: 9]
    { id: "trad_7", title: "Pav Bhaaji", details: "60 per plate", category: "COMBOS" }, [cite: 9]

    // SWEETS [cite: 9, 10]
    { id: "sweet_1", title: "Gulab Jamun", details: "20", category: "SWEETS" }, [cite: 9, 10]
    { id: "sweet_2", title: "Kheer", details: "80", category: "SWEETS" }, [cite: 10]
    { id: "sweet_3", title: "Sweet Rice", details: "90", category: "SWEETS" }, [cite: 10]
    { id: "sweet_4", title: "Shrikhand", details: "85 (250 gm)", category: "SWEETS" }, [cite: 10]

    // SABZI [cite: 10]
    { id: "sabzi_1", title: "Shaahi Paneer", details: "300", category: "SABZI" }, [cite: 10]
    { id: "sabzi_2", title: "Paneer Masala", details: "220", category: "SABZI" }, [cite: 10]
    { id: "sabzi_3", title: "Paneer Angara", details: "280", category: "SABZI" }, [cite: 10]
    { id: "sabzi_4", title: "Paneer Korma", details: "Price on request", category: "SABZI" }, [cite: 10]
    { id: "sabzi_5", title: "Palak Paneer", details: "200", category: "SABZI" }, [cite: 10]
    { id: "sabzi_6", title: "Matar Paneer", details: "200", category: "SABZI" }, [cite: 10]

    // NON-VEG [cite: 10]
    { id: "nv_1", title: "Chichen Afghani", details: "500", category: "NON-VEG" }, [cite: 10]
    { id: "nv_2", title: "Roasted Chicken", details: "340", category: "NON-VEG" }, [cite: 10]
    { id: "nv_3", title: "Chilli Chicken", details: "440", category: "NON-VEG" }, [cite: 10]
    { id: "nv_4", title: "Egg Curry", details: "75", category: "NON-VEG" }, [cite: 10]
    { id: "nv_5", title: "Fish Fry (boneless)", details: "180 (250 gm)", category: "NON-VEG" }, [cite: 10]
    { id: "nv_6", title: "Fish Dry (boneless)", details: "165 (250 gm)", category: "NON-VEG" }, [cite: 10]
    { id: "nv_7", title: "Chicken Shawarma", details: "90", category: "NON-VEG" }, [cite: 10]
    { id: "nv_8", title: "Mutton Curry", details: "400", category: "NON-VEG" }, [cite: 10]
    { id: "nv_9", title: "Mutton Korma", details: "430", category: "NON-VEG" }, [cite: 10]
    { id: "nv_10", title: "Keema Kaleji", details: "400", category: "NON-VEG" }, [cite: 10]
    { id: "nv_11", title: "Chicken Curry", details: "360", category: "NON-VEG" }, [cite: 10]
    { id: "nv_12", title: "Chicken Masala", details: "400", category: "NON-VEG" }, [cite: 10]
    { id: "nv_13", title: "Butter Chicken", details: "500", category: "NON-VEG" }, [cite: 10]

    // RICE [cite: 10, 11]
    { id: "rice_1", title: "Plain Rice", details: "90", category: "RICE" }, [cite: 10]
    { id: "rice_2", title: "Jeera Rice", details: "120", category: "RICE" }, [cite: 10]
    { id: "rice_3", title: "Matar Pulao", details: "140", category: "RICE" }, [cite: 10]
    { id: "rice_4", title: "Veg. Biryani", details: "180", category: "RICE" } [cite: 10, 11]
];
